{{-- resources/views/admin/kontak-desa/create.blade.php --}}
@extends('layouts.app')
...
<div class="container-premium">
    ...
    <div class="main-card animate__animated animate__fadeInUp">
        <div class="card-header">
            ...
            <p>Lengkapi form di bawah untuk menambahkan kontak perangkat desa</p>
        </div>

        <div class="card-body">
            <form action="{{ route('admin.kontak-desa.store') }}" method="POST" enctype="multipart/form-data" id="contactForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" required class="form-input" placeholder="Contoh: Jonatan Sitorus, S.Sos" value="{{ old('nama') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bidang" class="form-input" placeholder="Contoh: Pimpinan tertinggi desa" value="{{ old('bidang') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp" required class="form-input" placeholder="6281234567890" value="{{ old('no_hp') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="urutan" value="{{ old('urutan', 0) }}" class="form-input" placeholder="0">
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" onclick="document.getElementById('foto_input').click()">
                        ...
                        <div class="upload-title">Klik untuk upload foto</div>
                ...
                <div class="action-buttons">
                    ...
                    <button type="submit" class="btn-submit" id="submitBtn">
                        <i class="fa-regular fa-save"></i> Simpan Kontak
                    </button>
                </div>
            </form>
        </div>
    ...
    <div class="tutorial-section animate__animated animate__fadeInUp" style="animation-delay: 0.1s">
        <div class="tutorial-header">
            ...
            <h3>📖 Panduan Menambah Kontak</h3>
        </div>
        
        <p class="tutorial-intro">
            Halaman ini digunakan untuk menambahkan kontak perangkat desa baru. 
            Data yang diisi akan ditampilkan di halaman kontak publik.
        </p>
        ...
        <div class="tutorial-grid">
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    <h4>📝 Isi Data Diri</h4>
                    <p>Masukkan nama lengkap dan jabatan perangkat desa.</p>
                </div>
            </div>
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    ...
                    <p>Pastikan nomor WhatsApp valid dan aktif (format 628xxx).</p>
                </div>
            </div>
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    <h4>🖼️ Upload Foto</h4>
                    <p>Upload foto untuk tampilan lebih profesional (opsional).</p>
                </div>
            </div>
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    <h4>🔢 Urutan Tampil</h4>
                    <p>Atur urutan kemunculan di halaman publik.</p>
                </div>
            </div>
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    <h4>💾 Simpan Data</h4>
                    <p>Klik tombol "Simpan Kontak" untuk menyimpan ke database.</p>
                </div>
            </div>
            <div class="tutorial-item">
                ...
                <div class="tutorial-text">
                    <h4>💡 Tips</h4>
                    <p>Isi semua data dengan benar agar kontak berfungsi optimal.</p>
                </div>
            </div>
        </div>
        ...
        <div class="tutorial-footer">
            ...
            <span>💡 <strong>Tips Penting:</strong> Pastikan nomor WhatsApp menggunakan format internasional (628xxxxxxxx) agar link WhatsApp berfungsi dengan baik.</span>
        </div>
    </div>
...
<script>
    ...
    function updateFileName() {
        ...
        if (input.files && input.files[0]) {
            ...
            display.innerHTML = `<i class="fa-regular fa-circle-check"></i> ${fileName} (${fileSize} KB)`;
