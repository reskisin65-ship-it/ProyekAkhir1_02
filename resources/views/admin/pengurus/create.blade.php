...
@section('title', 'Tambah Pengurus Desa - Lumban Silintong')
...
<div class="container-premium">
    ...
    <div class="form-card animate-up delay-1">
        <div class="form-header">
            ...
            <p>Tambahkan data perangkat desa baru dengan hierarki jabatan otomatis</p>
        </div>
            ...
            <form action="{{ route('admin.pengurus.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="kategori-options">
                        @foreach($hierarki as $key => $kat)
                            @php
                                $disabled = in_array($key, ['kepala_desa', 'sekretaris_desa']) && ($kategoriCounts[$key] ?? 0) > 0;
                            @endphp
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" id="uploadArea">
                        ...
                        <p style="font-size: 0.8rem; color: var(--gray);">Klik atau drag & drop untuk upload foto</p>
                ...
                <div class="action-buttons">
                    ...
                    <button type="submit" class="btn-primary">
                        <i class="fa-regular fa-floppy-disk"></i> Simpan Pengurus
                    </button>
                </div>
            </form>
        </div>
