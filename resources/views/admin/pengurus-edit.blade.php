        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-8 py-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Edit Pengurus Desa</h1>
                        <p class="text-emerald-100 text-sm">Perbarui data perangkat desa</p>
                    </div>
                </div>
            </div>
            
            <form action="{{ route('admin.pengurus.update', $pengurus->id_pengurus) }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pengurus" value="{{ old('nama_pengurus', $pengurus->nama_pengurus ?? $pengurus->nama) }}" required
                    ...
                    <div>
                        ...
                        <textarea name="tugas" rows="3"
                                  class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition resize-none">{{ old('tugas', $pengurus->tugas) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-emerald-400 transition">
                            @if($pengurus->foto)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $pengurus->foto) }}" class="h-24 mx-auto rounded-lg shadow-md">
                            ...
                            <label for="foto" class="cursor-pointer flex flex-col items-center gap-2">
                                ...
                                <span class="text-sm text-gray-500">{{ $pengurus->foto ? 'Ganti foto' : 'Upload foto' }}</span>
                    ...
                    <div>
                        ...
                        <input type="number" name="urutan" value="{{ old('urutan', $pengurus->urutan ?? 0) }}"
                               class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition">
                    </div>
                </div>
