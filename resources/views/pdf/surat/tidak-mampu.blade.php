...
@include('pdf.surat.partials.letter-header', [
    ...
    'perihal' => 'Keterangan Tidak Mampu (SKTM)',
...
<div class="content">
    ...
    <table class="data">
        ...
        <tr><td>5.</td><td>Pekerjaan</td><td>:</td><td>{{ $pekerjaan }}</td></tr>

        <tr><td>6.</td><td>Status Perkawinan</td><td>:</td><td>{{ $statusPerkawinan }}</td></tr>
    ...
    <p>Adalah benar-benar warga {{ $namaDesa }} yang tergolong keluarga tidak mampu / berpenghasilan rendah berdasarkan data dan keterangan yang diberikan.</p>
